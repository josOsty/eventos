      ...
      <div class="lodgo">
       ...
       <div class="login-box">
        ...
        <form class="login-form" id="guardarDatos" method="POST">
          <h4 class="login-head" onclick="modPersonal()">REGISTRAR PARTICIPANTES</h4>
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="number" name="cedula" id="cedula" placeholder="Ingrese su n° de cedula"  required >
          </div>
          ...
          <div class="form-group btn-container">
            <button id="btnguardar" class="btn btn-primary btn-block"><i class="fa fa-check"></i>CONFIRMAR</button>
          </div>
        </form>
