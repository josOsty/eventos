...
if ($quincena == 'PRIMERA') {
    ...
    $objPHPExcel->getActiveSheet()->getStyle('A1:R2')->applyFromArray($estiloTituloReporte);
    $objPHPExcel->getActiveSheet()->getStyle('A2:R2')->applyFromArray($estiloTituloColumnas);

    $objPHPExcel->getActiveSheet()->setCellValue('B1', 'ASISTENCIA' . " " . $quincena . " " . "QUINCENA" . " " . "MES" . " " . $mes . " " . $anio);
...
//Recorremos los resultados de la consulta y los imprimimos
    ...
    $objPHPExcel->getActiveSheet()->setSharedStyle($estiloInformacion, "A3:R" . $fila);

    $writer = PHPExcel_IOFactory::createWriter($objPHPExcel, 'Excel2007');

    header("Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet");
    header('Content-Disposition: attachment;filename="Estadistica.xlsx"');
    ...
    $objPHPExcel->getActiveSheet()->getStyle('D5')->getAlignment()->setWrapText(true);
    $objPHPExcel->getActiveSheet()->getColumnDimension('D')->setWidth(10.57);
    $objPHPExcel->getActiveSheet()->setCellValue('D2', '16');
    $objPHPExcel->getActiveSheet()->getColumnDimension('E')->setWidth(10.57);
    $objPHPExcel->getActiveSheet()->setCellValue('E2', '17');
    $objPHPExcel->getActiveSheet()->getColumnDimension('F')->setWidth(10.25);
    $objPHPExcel->getActiveSheet()->setCellValue('F2', '18');
    $objPHPExcel->getActiveSheet()->getColumnDimension('G')->setWidth(10.25);
    $objPHPExcel->getActiveSheet()->setCellValue('G2', '19');
    $objPHPExcel->getActiveSheet()->getColumnDimension('H')->setWidth(10.25);
    $objPHPExcel->getActiveSheet()->setCellValue('H2', '20');
    $objPHPExcel->getActiveSheet()->getColumnDimension('I')->setWidth(10.25);
    $objPHPExcel->getActiveSheet()->setCellValue('I2', '21');
    $objPHPExcel->getActiveSheet()->getColumnDimension('J')->setWidth(10.25);
    $objPHPExcel->getActiveSheet()->setCellValue('J2', '22');
    $objPHPExcel->getActiveSheet()->getColumnDimension('K')->setWidth(10.25);
    $objPHPExcel->getActiveSheet()->setCellValue('K2', '23');
    $objPHPExcel->getActiveSheet()->getColumnDimension('L')->setWidth(10.25);
    $objPHPExcel->getActiveSheet()->setCellValue('L2', '24');
    $objPHPExcel->getActiveSheet()->getColumnDimension('M')->setWidth(10.25);
    $objPHPExcel->getActiveSheet()->setCellValue('M2', '25');
    $objPHPExcel->getActiveSheet()->getColumnDimension('N')->setWidth(10.25);
    $objPHPExcel->getActiveSheet()->setCellValue('N2', '26');
    $objPHPExcel->getActiveSheet()->getColumnDimension('O')->setWidth(10.25);
    $objPHPExcel->getActiveSheet()->setCellValue('O2', '27');
    $objPHPExcel->getActiveSheet()->getColumnDimension('P')->setWidth(10.25);
    $objPHPExcel->getActiveSheet()->setCellValue('P2', '28');
    $objPHPExcel->getActiveSheet()->getColumnDimension('Q')->setWidth(10.25);
    $objPHPExcel->getActiveSheet()->setCellValue('Q2', '29');
    $objPHPExcel->getActiveSheet()->getColumnDimension('R')->setWidth(10.25);
    $objPHPExcel->getActiveSheet()->setCellValue('R2', '30');
    $objPHPExcel->getActiveSheet()->getColumnDimension('S')->setWidth(10.25);
    $objPHPExcel->getActiveSheet()->setCellValue('S2', '31');
...
//Recorremos los resultados de la consulta y los imprimimos
    ...
    foreach ($asistencia as $key => $value) {
        ...
        if ($value[d16] == 1) {$objPHPExcel->getActiveSheet()->setCellValue('D' . $fila, A);} else {if ($fecha < "$anio-$mes-16") {$objPHPExcel->getActiveSheet()->setCellValue('D' . $fila, "");} else { $objPHPExcel->getActiveSheet()->setCellValue('D' . $fila, I);}}
        if ($value[d17] == 1) {$objPHPExcel->getActiveSheet()->setCellValue('E' . $fila, A);} else {if ($fecha < "$anio-$mes-17") {$objPHPExcel->getActiveSheet()->setCellValue('E' . $fila, "");} else { $objPHPExcel->getActiveSheet()->setCellValue('E' . $fila, I);}}

        if ($value[d18] == 1) {$objPHPExcel->getActiveSheet()->setCellValue('F' . $fila, A);} else {if ($fecha < "$anio-$mes-18") {$objPHPExcel->getActiveSheet()->setCellValue('F' . $fila, "");} else { $objPHPExcel->getActiveSheet()->setCellValue('F' . $fila, I);}}

        if ($value[d19] == 1) {$objPHPExcel->getActiveSheet()->setCellValue('G' . $fila, A);} else {if ($fecha < "$anio-$mes-19") {$objPHPExcel->getActiveSheet()->setCellValue('G' . $fila, "");} else { $objPHPExcel->getActiveSheet()->setCellValue('G' . $fila, I);}}

        if ($value[d20] == 1) {$objPHPExcel->getActiveSheet()->setCellValue('H' . $fila, A);} else {if ($fecha < "$anio-$mes-20") {$objPHPExcel->getActiveSheet()->setCellValue('H' . $fila, "");} else { $objPHPExcel->getActiveSheet()->setCellValue('H' . $fila, I);}}

        if ($value[d21] == 1) {$objPHPExcel->getActiveSheet()->setCellValue('I' . $fila, A);} else {if ($fecha < "$anio-$mes-21") {$objPHPExcel->getActiveSheet()->setCellValue('I' . $fila, "");} else { $objPHPExcel->getActiveSheet()->setCellValue('I' . $fila, I);}}

        if ($value[d22] == 1) {$objPHPExcel->getActiveSheet()->setCellValue('J' . $fila, A);} else {if ($fecha < "$anio-$mes-22") {$objPHPExcel->getActiveSheet()->setCellValue('J' . $fila, "");} else { $objPHPExcel->getActiveSheet()->setCellValue('J' . $fila, I);}}

        if ($value[d23] == 1) {$objPHPExcel->getActiveSheet()->setCellValue('K' . $fila, A);} else {if ($fecha < "$anio-$mes-23") {$objPHPExcel->getActiveSheet()->setCellValue('K' . $fila, "");} else { $objPHPExcel->getActiveSheet()->setCellValue('K' . $fila, I);}}

        if ($value[d24] == 1) {$objPHPExcel->getActiveSheet()->setCellValue('L' . $fila, A);} else {if ($fecha < "$anio-$mes-24") {$objPHPExcel->getActiveSheet()->setCellValue('L' . $fila, "");} else { $objPHPExcel->getActiveSheet()->setCellValue('L' . $fila, I);}}
        if ($value[d25] == 1) {$objPHPExcel->getActiveSheet()->setCellValue('M' . $fila, A);} else {if ($fecha < "$anio-$mes-25") {$objPHPExcel->getActiveSheet()->setCellValue('M' . $fila, "");} else { $objPHPExcel->getActiveSheet()->setCellValue('M' . $fila, I);}}

        if ($value[d26] == 1) {$objPHPExcel->getActiveSheet()->setCellValue('N' . $fila, A);} else {if ($fecha < "$anio-$mes-26") {$objPHPExcel->getActiveSheet()->setCellValue('N' . $fila, "");} else { $objPHPExcel->getActiveSheet()->setCellValue('N' . $fila, I);}}

        if ($value[d27] == 1) {$objPHPExcel->getActiveSheet()->setCellValue('O' . $fila, A);} else {if ($fecha < "$anio-$mes-27") {$objPHPExcel->getActiveSheet()->setCellValue('O' . $fila, "");} else { $objPHPExcel->getActiveSheet()->setCellValue('O' . $fila, I);}}
        if ($value[d28] == 1) {$objPHPExcel->getActiveSheet()->setCellValue('P' . $fila, A);} else {if ($fecha < "$anio-$mes-28") {$objPHPExcel->getActiveSheet()->setCellValue('P' . $fila, "");} else { $objPHPExcel->getActiveSheet()->setCellValue('P' . $fila, I);}}
        if ($value[d29] == 1) {$objPHPExcel->getActiveSheet()->setCellValue('Q' . $fila, A);} else {if ($fecha < "$anio-$mes-29") {$objPHPExcel->getActiveSheet()->setCellValue('Q' . $fila, "");} else { $objPHPExcel->getActiveSheet()->setCellValue('Q' . $fila, I);}}

        if ($value[d30] == 1) {$objPHPExcel->getActiveSheet()->setCellValue('R' . $fila, A);} else {if ($fecha < "$anio-$mes-30") {$objPHPExcel->getActiveSheet()->setCellValue('R' . $fila, "");} else { $objPHPExcel->getActiveSheet()->setCellValue('R' . $fila, I);}}

        if ($value[d31] == 1) {$objPHPExcel->getActiveSheet()->setCellValue('S' . $fila, A);} else {if ($fecha < "$anio-$mes-31") {$objPHPExcel->getActiveSheet()->setCellValue('S' . $fila, "");} else { $objPHPExcel->getActiveSheet()->setCellValue('S' . $fila, I);}}
        $fila++; //Sumamos 1 para pasar a la siguiente fila
    ...
    $objPHPExcel->getActiveSheet()->setSharedStyle($estiloInformacion, "A3:S" . $fila);
